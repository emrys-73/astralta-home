...
<div 
    ...
    class="flex flex-col w-full h-full min-h-[100vh] justify-center items-center px-6 text-white py-10 pb-40">
    <h1 class="w-full md:w-2/3 lg:w-1/2 text-center mt-20 pt-10 pb-4">
    ...
    <div class="flex flex-col lg:flex-row gap-6 justify-center items-start py-1">
        
        <div class="max-w-[400px] w-full h-full rounded-2xl bg-white bg-opacity-5 border-[0.5px] border-white border-opacity-20 p-6 min-h-60 altashadow hover:bg-opacity-10 transition-all duration-300 ease-in-out">
            ...
            <div class="py-2">
                <Button href={$calendly} class="rounded-full bg-emerald-700 text-white font-semibold transition-all duration-300 ease-in-out hover:bg-white hover:text-black hover:px-10">
                    Start with a call
                </Button>
            </div>
        </div>
        ...
        <!-- (i.e. Custom Assistant, Predictive Analysis, Pricing Strategy with Machine Learning, Customer Sentiment Analysis and more) -->
    ...
    <div
    class="md:w-1/2 w-full text-center px-4 py-4">
    <p class="tracking-wide opacity-40 font-light">
        * Custom Assistant, Predictive Analysis, Pricing Strategy with Machine Learning, Customer Sentiment Analysis and more
    </p>


    <div
    class="w-full text-center px-4 py-4 text-[#838383]">
        For Web App or SaaS development <a href="mailto:montoya@astralta.com" class="text-white">contact sales</a>
    </div>
