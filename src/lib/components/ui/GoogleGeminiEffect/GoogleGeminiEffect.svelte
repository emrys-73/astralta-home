...
// @ts-nocheck
    ...
    export let pathLengths;
    export let cta = void 0;
    ...
    <div class={cn('sticky top-20', className)}>
        <p
            class="bg-gradient-to-b from-neutral-100 to-neutral-300 bg-clip-text pb-4 text-center font-bold text-4xl sm:text-5xl px-4 text-transparent md:text-7xl"
        >
            {title || `Build with AI from the ground up`}
        </p>
        <p class="mx-auto mt-4 px-8 max-w-lg text-center font-regular text-neutral-400 md:text-xl">
            Bring <b class="text-white font-normal">the world's most powerful AI </b> models into your <b class="text-white font-normal">Web App</b>.
        </p>
        <div
            class="bg-red-transparent absolute -top-60 flex h-[890px] w-full items-center justify-center md:-top-40"
        >
            <div
                class="z-30 mx-auto mt-8 w-fit rounded-full bg-white px-2 py-1 text-xs font-bold text-black md:mt-24 md:px-4 md:py-2 md:text-base drop-shadow-xl"
            >
                { cta || `Learn More` }
            </div>
        </div>
        ...
        <svg
            ...
            class=" absolute -top-60 w-full md:-top-40"
        >
            <Motion
                let:motion
                isSVG={true}
